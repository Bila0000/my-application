package com.salsabil.chatapp.Adapter;
...
import com.salsabil.chatapp.MessegeActivity;
import com.salsabil.chatapp.Model.Chat;
import com.salsabil.chatapp.Model.User;
import com.salsabil.chatapp.R;
...
holder.itemView.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View v) {
        Intent intent = new Intent(nContext, MessegeActivity.class);
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    if(chat.getReceiver().equals(firebaseUser.getUid()) && chat.getSender().equals(userid) ||
                     chat.getReceiver().equals(userid) && chat.getSender().equals(firebaseUser.getUid())){
                        theLastMessage = chat.getMessege();
                    }
                }
